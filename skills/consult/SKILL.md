...
description: Ask the advisor a direct question on the user's behalf. Use
  when the user says "/consult ...", "ask the advisor ...", or "what does
  ...
  qualifies. Named /consult, not /advisor - Claude Code has a built-in
  /advisor command that shadows any plugin skill of that name.
---
